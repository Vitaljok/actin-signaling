...
def build_rules(option='A'):
    """ Actin network rules.
        ...
        Changes from v2:
            ...
            * Option B: PAK -| Cortactin
            * Option C: PAK -> Cortactin            
    """
    ...
    if option == 'A':
        ...
        G.add_weighted_edges_from(get_edges(Cortactin, [Rac1], [Coronin, PKD, PAK]))
        rules += "1: Cortactin* = "+ voting_rule([Rac1], [Coronin, PKD, PAK]) +" \n"
    elif option == 'C':
        G.add_weighted_edges_from(get_edges(Cortactin, [Rac1, PAK], [Coronin, PKD]))
        rules += "1: Cortactin* = "+ voting_rule([Rac1, PAK], [Coronin, PKD]) +" \n"
    else:
